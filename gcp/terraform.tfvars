...
region         = "us-west4"  // region in which your cluster will be deployed
namespace      = "coder"        // k8s namespace in which Coder will be installed
coder_version  = "1.20"           // coder version to be installed - if null, latest version will be used
...
max_node_count = 2              // max amount of nodes provisioned by auto-scaling